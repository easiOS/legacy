all:
	...
	#i686-elf-gcc -c port.c -o port.o -std=gnu99 -ffreestanding -O2 -Wall -Wextra
	#i686-elf-gcc -c port.c -o port.o -std=gnu99 -ffreestanding -O2 -Wall -Wextra
	...
	i686-elf-gcc -c shell.c -o shell.o -std=gnu99 -ffreestanding -O2 -Wall -Wextra
	i686-elf-gcc -T linker.ld -o easios.bin -ffreestanding -O2 -nostdlib boot.o int.o itoa.o stdmem.o keyboard.o dtables2.o dtables.o timer.o kernel.o video.o shell.o -lgcc
